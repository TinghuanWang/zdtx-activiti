...
var KisBpmAssignmentPopupCtrl = ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.dataWatch = function () {
        ...
        $scope.changeOne = function () {
            var onelevel = $scope.searcher.ShipAddressOne;
            $scope.selectedProject = onelevel;
            $scope.getPagedDataAsync($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, $scope.selectedProject);

            if (!angular.equals("", onelevel)) {
                $scope.TwoList = $scope.projects.find(c => c.key === onelevel).children;
            } else {
                $scope.TwoList = null;
                $scope.ThreeList = null;
                $scope.FourList = null;
                $scope.FiveList = null;
            }
        };
        $scope.changeTwo = function () {
            var twolevel = $scope.searcher.ShipAddressTwo;
            $scope.selectedProject = twolevel;
            $scope.getPagedDataAsync($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, $scope.selectedProject);

            if (!angular.equals("", twolevel)) {
                $scope.ThreeList = $scope.TwoList.find(c => c.key === twolevel).children;
            } else {
                $scope.ThreeList = null;
                $scope.FourList = null;
                $scope.FiveList = null;
        ...
        $scope.changeThree = function () {
            var threelevel = $scope.searcher.ShipAddressThree;
            $scope.selectedProject = threelevel;
            $scope.getPagedDataAsync($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, $scope.selectedProject);

            if (!angular.equals("", threelevel)) {
                $scope.FourList = $scope.ThreeList.find(c => c.key === threelevel).children;
            } else {
                $scope.FourList = null;
                $scope.FiveList = null;
            }
        ...
        $scope.changeFour = function () {
            var fourlevel = $scope.searcher.ShipAddressFour;
            $scope.selectedProject = fourlevel;
            $scope.getPagedDataAsync($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, $scope.selectedProject);
            if (!angular.equals("", fourlevel)) {
                $scope.FiveList = $scope.FourList.find(c => c.key === fourlevel).children;
            } else {
                $scope.FiveList = null;
            }
        };
        ...
        $scope.changeFive = function () {
            var fivelevel = $scope.searcher.ShipAddressFive;
            $scope.selectedProject = fivelevel;
            $scope.getPagedDataAsync($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, $scope.selectedProject);
        };
    };
