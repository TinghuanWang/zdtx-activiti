...
<head>
    ...
    <link rel="stylesheet" href="editor-app/libs/bootstrap_3.1.1/css/bootstrap-treeview.min.css"/>
...
<script src="editor-app/libs/bootstrap_3.1.1/js/bootstrap-treeview.min.js"></script>
