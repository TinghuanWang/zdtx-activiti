...
(function($) {
	...
	methods = {
		...
		init: function(options) {
			...
			cont.eq(0).addClass("myactive");
//			$(".mycenter-block button").eq(1).removeClass("btn-default");
//			$(".mycenter-block button").eq(2).removeClass("btn-default");
		},
		...
		next: function() {
			...
			cont.eq(i).siblings(cont).removeClass("myactive");
			cont.eq(i).addClass("myactive");
		},
		...
		previous: function() {
			...
			cont.eq(i).removeClass("myactive");
			cont.eq(i).prev(cont).addClass("myactive");
		},
